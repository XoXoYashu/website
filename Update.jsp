...
<div class="container">
  <form method="get" action="UpdateDelete">
    <div class="row">
      ...
      <div class="col">
		...
		<td>First Name:</td>
        <input type="text" name="firstname" placeholder="e.g: Yashu" required>
        <td>Eamil:</td>
...
<div class="bottom-container">
  <div class="row">
    ...
    <div class="col">
      <a href="Delete.jsp" style="color:white" class="btn">Delete</a>
    </div>
</div>
